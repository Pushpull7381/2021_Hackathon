...
finishButton.addEventListener('click',mvmv);
function mvmv(){
  //window.open("https://www.naver.com/");//새창으로 열기
  window.location.href="https://www.naver.com/" //기존 창에서 열기
}
...
function changeimg(){
  if(((100 * countRightAnswers)/questions.length)*1>=80){
    document.getElementById('sf').src="success.png";
    ...
    document.getElementById('sf').src="fail.png";
